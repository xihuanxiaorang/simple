...
import top.xiaorang.simple.system.exception.BizException;
...
public class ImageCodeProcessor extends AbstractValidateCodeProcessor<ImageCode> {
    public ImageCodeProcessor(ValidateCodeRepository validateCodeRepository, ImageCodeGenerator imageCodeGenerator) {
    ...
    protected JsonResult<String> send(ImageCode imageCode) {
        ...
        try {
            ...
            throw new BizException(ResultCode.VALIDATE_CODE_CREATE_FAIL);
        }
